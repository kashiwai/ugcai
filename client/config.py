...
CHARACTERS = {
    "miku": {
        "name": "みく (22歳OL)",
        "face_image": str(_ASSETS / "miku.png"),
    ...
    "kenta": {
        "name": "けんた (27歳営業)",
        "face_image": str(_ASSETS / "kenta.png"),
    ...
    "ayaka": {
        "name": "あやか (19歳学生)",
        "face_image": str(_ASSETS / "ayaka.png"),
    ...
    "dr_tanaka": {
        "name": "Dr.田中 (歯科医師)",
        "face_image": str(_ASSETS / "dr_tanaka.png"),
    ...
    "mariko": {
        "name": "まりこ (32歳ママ)",
        "face_image": str(_ASSETS / "mariko.png"),
    ...
    "yuki": {
        "name": "ゆうき (25歳フリー)",
        "face_image": str(_ASSETS / "yuki.png"),
    ...
    "sakura": {
        "name": "さくら (解説役)",
        "face_image": str(_ASSETS / "sakura.png"),
    ...
    "reviewer": {
        "name": "辛口レビュアー",
        "face_image": str(_ASSETS / "reviewer.png"),
